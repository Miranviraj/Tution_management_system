...
import 'package:tmms/item_note.dart';
import 'package:tmms/addstu.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  Image.asset('/tutor.png', width: 250),
                ],
              ),
            ),
          ),
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                decoration: InputDecoration(labelText: "'Parent's Telephone Number "),
              ),
              TextField(
          ...
          actions: <Widget>[
            ...
            TextButton(
              child: Text('Add'),
              onPressed: () {
                // Add student details logic here
                Navigator.of(context).pop();
              },
            ),
          ],
