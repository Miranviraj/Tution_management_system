...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future<void> _refreshStudents() async {
    final data = await DBHelper.instance.fetchStudents2();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertStudent2(Student(name: name, tell: tell, address: address,));
    } else {
      await DBHelper.instance.updateStudent2(Student(id: _editingId, name: name, tell: tell, address: address));
    }
  ...
  Future<void> _deleteStudent(int id) async {
    await DBHelper.instance.deleteStudent2(id);
    _refreshStudents();
  }
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                await DBHelper.instance.updateStudent2( Student(
                  id: student.id,
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    child: ListTile(
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedStudent != null) {
                                await DBHelper.instance.updateStudent2(updatedStudent);
                                setState(() {}); // Refresh UI
                              }
                            },
                          ),
                      ...
                      onTap: () async {
                        final payments = await DBHelper.instance.fetchPaymentsByStudentId2(student.id!);
                        final attendanceCount = await DBHelper.instance.fetchAttendanceCountByStudentId2(student.id!);
...
class ClassesScreenState extends State< ClassesScreen> {
  ...
  Future<void> _refreshclasse() async {
    final data = await DBHelper.instance.fetchclasses2();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertclass2(Classes(date: date, time: time));
    } else {
      await DBHelper.instance.updateclass2(Classes(
  ...
  Future<Classes?> showUpdateDialog(BuildContext context, Classes classes) async {
    ...
    Future<void> sendSmsToAllStudents(String date, String time) async {
      ...
      if (permissionsGranted == true) {
        try {
          final studentData = await DBHelper.instance.fetchStudents2();
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedClass != null) {
                                await DBHelper.instance.updateclass2(
                                    updatedClass);
...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Future<void> _loadStudents() async {
    final studentMaps = await DBHelper.instance.getAllStudents2();
    setState(() {
  ...
  Future<void> _saveAttendance() async {
    ...
    for (var entry in _presentStatus.entries) {
      ...
      if (entry.value) { // Check if the student is present
        await DBHelper.instance.incrementStudentAttendance2(entry.key);
      }
    }
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _fetchPayments() async {
    final data = await DBHelper.instance.fetchPayments2();
    setState(() {
  ...
  Future<void> _addOrUpdatePayment() async {
    ...
    if (_editingPaymentId == null) {
      await DBHelper.instance.insertPayment2(
        Payment(
          studentId: studentId,
          amount: amount,
          date: formattedDate,
  ...
  Future<void> _deletePayment(int id) async {
    await DBHelper.instance.deletePayment2(id);
    _fetchPayments();
  }
