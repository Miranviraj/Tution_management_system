...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future<void> _refreshStudents() async {
    final data = await DBHelper.instance.fetchStudents1();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertStudent1(Student(name: name, tell: tell, address: address,));
    } else {
      await DBHelper.instance.updateStudent1(Student(id: _editingId, name: name, tell: tell, address: address));
    }
  ...
  Future<void> _deleteStudent(int id) async {
    await DBHelper.instance.deleteStudent1(id);
    _refreshStudents();
  }
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                await DBHelper.instance.updateStudent1( Student(
                  id: student.id,
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    child: ListTile(
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedStudent != null) {
                                await DBHelper.instance.updateStudent1(updatedStudent);
                                setState(() {}); // Refresh UI
                              }
                            },
                          ),
                      ...
                      onTap: () async {
                        final payments = await DBHelper.instance.fetchPaymentsByStudentId1(student.id!);
                        final attendanceCount = await DBHelper.instance.fetchAttendanceCountByStudentId1(student.id!);
...
class ClassesScreenState extends State< ClassesScreen> {
  ...
  Future<void> _refreshclasse() async {
    final data = await DBHelper.instance.fetchclasses1();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertclass1(Classes(date: date, time: time));
    } else {
      await DBHelper.instance.updateclass1(Classes(
  ...
  Future<void> _deleteclass(int id) async {
    await DBHelper.instance.deleteclass1(id);
    _refreshclasse();
  }
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedClass != null) {
                                await DBHelper.instance.updateclass1(
                                    updatedClass);
...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Future<void> _loadStudents() async {
    final studentMaps = await DBHelper.instance.getAllStudents1();
    setState(() {
  ...
  Future<void> _saveAttendance() async {
    ...
    for (var entry in _presentStatus.entries) {
      ...
      await DBHelper.instance.insertAttendance1(attendance.toMap());

      // Increment the attendance count only for present students
      if (entry.value) { // Check if the student is present
        await DBHelper.instance.incrementStudentAttendance1(entry.key);
      }
    }
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _fetchPayments() async {
    final data = await DBHelper.instance.fetchPayments1();
    setState(() {
  ...
  Future<void> _addOrUpdatePayment() async {
    ...
    if (_editingPaymentId == null) {
      await DBHelper.instance.insertPayment1(
        Payment(
          studentId: studentId,
          amount: amount,
          date: formattedDate,
  ...
  Future<void> _deletePayment(int id) async {
    await DBHelper.instance.deletePayment1(id);
    _fetchPayments();
  }
