...
class Grade8 extends StatelessWidget {
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future<void> _refreshStudents() async {
    final data = await DBHelper.instance.fetchStudents8();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertStudent8(Student(name: name, tell: tell, address: address,));
    } else {
      await DBHelper.instance.updateStudent8(Student(id: _editingId, name: name, tell: tell, address: address));
    }
  ...
  Future<void> _deleteStudent(int id) async {
    await DBHelper.instance.deleteStudent8(id);
    _refreshStudents();
  }
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                await DBHelper.instance.updateStudent8( Student(
                  id: student.id,
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    child: ListTile(
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedStudent != null) {
                                await DBHelper.instance.updateStudent8(updatedStudent);
                                setState(() {}); // Refresh UI
                              }
                            },
                          ),
                      ...
                      onTap: () async {
                        final payments = await DBHelper.instance.fetchPaymentsByStudentId8(student.id!);
                        final attendanceCount = await DBHelper.instance.fetchAttendanceCountByStudentId8(student.id!);
...
class ClassesScreenState extends State< ClassesScreen> {
  ...
  Future<void> _refreshclasse() async {
    final data = await DBHelper.instance.fetchclasses8();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertclass8(Classes(date: date, time: time));
    } else {
  ...
  Future<void> _deleteclass(int id) async {
    await DBHelper.instance.deleteclass8(id);
    _refreshclasse();
  }
  ...
  Future<Classes?> showUpdateDialog(BuildContext context, Classes classes) async {
    ...
    Future<void> sendSmsToAllStudents(String date, String time) async {
      ...
      if (permissionsGranted == true) {
        try {
          final studentData = await DBHelper.instance.fetchStudents8();
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedClass != null) {
                                await DBHelper.instance.updateclass8(
                                    updatedClass);
...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Future<void> _loadStudents() async {
    final studentMaps = await DBHelper.instance.getAllStudents8();
    setState(() {
  ...
  Future<void> _saveAttendance() async {
    ...
    for (var entry in _presentStatus.entries) {
      ...
      await DBHelper.instance.insertAttendance8(attendance.toMap());

      // Increment the attendance count only for present students
      if (entry.value) { // Check if the student is present
        await DBHelper.instance.incrementStudentAttendance8(entry.key);
      }
    }
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _fetchPayments() async {
    final data = await DBHelper.instance.fetchPayments8();
    setState(() {
  ...
  Future<void> _addOrUpdatePayment() async {
    ...
    if (_editingPaymentId == null) {
      await DBHelper.instance.insertPayment8(
        Payment(
          studentId: studentId,
          amount: amount,
          date: formattedDate,
  ...
  Future<void> _deletePayment(int id) async {
    await DBHelper.instance.deletePayment8(id);
    _fetchPayments();
  }
