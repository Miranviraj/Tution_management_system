...
class Grade7 extends StatelessWidget {
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future<void> _refreshStudents() async {
    final data = await DBHelper.instance.fetchStudents7();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertStudent7(Student(name: name, tell: tell, address: address,));
    } else {
      await DBHelper.instance.updateStudent7(Student(id: _editingId, name: name, tell: tell, address: address));
    }
  ...
  Future<void> _deleteStudent(int id) async {
    await DBHelper.instance.deleteStudent7(id);
    _refreshStudents();
  }
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                await DBHelper.instance.updateStudent7( Student(
                  id: student.id,
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    child: ListTile(
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedStudent != null) {
                                await DBHelper.instance.updateStudent7(updatedStudent);
                                setState(() {}); // Refresh UI
                              }
                            },
                          ),
                      ...
                      onTap: () async {
                        final payments = await DBHelper.instance.fetchPaymentsByStudentId7(student.id!);
                        final attendanceCount = await DBHelper.instance.fetchAttendanceCountByStudentId7(student.id!);
...
class ClassesScreenState extends State< ClassesScreen> {
  ...
  Future<void> _refreshclasse() async {
    final data = await DBHelper.instance.fetchclasses7();
    setState(() {
  ...
  Future<void> _addOrUpdateStudent() async {
    ...
    if (_editingId == null) {
      await DBHelper.instance.insertclass7(Classes(date: date, time: time));
    } else {
      await DBHelper.instance.updateclass7(Classes(
  ...
  Future<void> _deleteclass(int id) async {
    await DBHelper.instance.deleteclass7(id);
    _refreshclasse();
  }
  ...
  Future<Classes?> showUpdateDialog(BuildContext context, Classes classes) async {
    ...
    Future<void> sendSmsToAllStudents(String date, String time) async {
      ...
      if (permissionsGranted == true) {
        try {
          final studentData = await DBHelper.instance.fetchStudents7();
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (updatedClass != null) {
                                await DBHelper.instance.updateclass7(
                                    updatedClass);
                                _refreshclasse(); //
                              }
                            },
...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Future<void> _loadStudents() async {
    final studentMaps = await DBHelper.instance.getAllStudents7();
    setState(() {
  ...
  Future<void> _saveAttendance() async {
    ...
    for (var entry in _presentStatus.entries) {
      ...
      await DBHelper.instance.insertAttendance2(attendance.toMap());
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _fetchPayments() async {
    final data = await DBHelper.instance.fetchPayments7();
    setState(() {
  ...
  Future<void> _addOrUpdatePayment() async {
    ...
    if (_editingPaymentId == null) {
      await DBHelper.instance.insertPayment7(
        Payment(
          studentId: studentId,
          amount: amount,
          date: formattedDate,
  ...
  Future<void> _deletePayment(int id) async {
    await DBHelper.instance.deletePayment7(id);
    _fetchPayments();
  }
